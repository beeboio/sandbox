...
return [
    ...
    'apps' => [
        [
            'id' => env('BEEBO_APP_ID'),
            'name' => env('APP_NAME'),
            'key' => env('BEEBO_APP_KEY'),
            'secret' => env('BEEBO_APP_SECRET'),
            'path' => env('BEEBO_APP_PATH'),
            'capacity' => null,
            'enable_client_messages' => false,
            'enable_statistics' => true,
            //'socketio_parser' => Parser::TYPE_MSGPACK,
        ],
    ],
     ...
     */
    'app_provider' => \Beebo\Providers\WebSocketAppProvider::class,
